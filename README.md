# openharmony rvbook gn移植
forked from [https://github.com/huakunyang/SummerTTS/tree/main](https://github.com/huakunyang/SummerTTS/tree/main)

# how to build
`./build.sh --product-name rvbook -T ttshzy`

# other configs
- example/bundle.json
- vendor\iacas\rvbook\config.json
